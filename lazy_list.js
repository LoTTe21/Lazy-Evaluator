...
/*
const test = "const a = pair(non_existing, 22); const list_head = head(a); display(list_head); const non_existing = 11; ";
parse_and_eval(test);
*/

/*
const one = 1;
const two = map(x => {return x*2;}, one);
*/

/*
const a = "function generate(x) { return pair(x, generate(x));} const a = head(tail(generate(1))); a;";
parse_and_eval(a);
*/

/*
make_block(parse("function list (x,y) {return x;} list(1, head(null));"));

local_names([ "sequence",
...
parse_and_eval("function list (x,y) {return x;} list(1, head(null));");
